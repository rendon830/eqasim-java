...
/**
 * Class  defines the mode parameters for the base SMM mode choice model, based on Krauss et al
 */
public class SMMModeParameters extends ModeParameters {
    ...
    public static SMMModeParameters buildDefault() {
        // This is a copy & paste

        SMMModeParameters parameters = new SMMModeParameters();
