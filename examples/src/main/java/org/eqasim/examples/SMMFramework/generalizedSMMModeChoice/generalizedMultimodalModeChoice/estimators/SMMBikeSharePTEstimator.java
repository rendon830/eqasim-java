 ...
 */
public class SMMBikeSharePTEstimator implements UtilityEstimator {
    ...
    public SMMBikeSharePTEstimator(SMMParameters parameters, SMMBikeSharePTPredictor sharingPTPredictor, String mode) {
