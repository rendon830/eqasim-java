...
/**
 * Class predicts the characteristics of a  PT eScooter trip
 */
public class SMMPTEScooterPredictor extends CachedVariablePredictor<SharingPTVariables> {
    ...
    public SMMPTEScooterPredictor(SMMMultimodalCostModel multimodalCostModel, SMMCostParameters parameters, String name, String underlyingMode) {
    ...
    public SharingPTVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
        ...
        DiscreteModeChoiceTrip ptTrip = new DiscreteModeChoiceTrip(trip.getOriginActivity(),(Activity) elements.get(egressIndex), "pt",ptSplit,person.hashCode(),trip.hashCode(),0);
        DiscreteModeChoiceTrip egressTrip = new DiscreteModeChoiceTrip((Activity) elements.get(egressIndex),trip.getDestinationActivity(), "sharing:"+mode,egressSplit,person.getPlans().hashCode(),0,0);
