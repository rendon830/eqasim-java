...
/**
 * Class calculates the cost of a bikeshare trip based in cots per min + unlocking fee
 */
public class SMMBikeShareCostModel extends AbstractCostModel {

    private final SMMCostParameters parameters;

        public SMMBikeShareCostModel(SMMCostParameters parameters) {
            super("sharing:bikeShare");
            this.parameters = parameters;

        }

    public SMMBikeShareCostModel(SMMCostParameters parameters , String name) {
        super(name);
        this.parameters = parameters;
