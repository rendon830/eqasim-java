...
/**
 * Class  acts as container for bikesharing trip variables for utility
 */
public class SMMBikeShareVariables implements BaseVariables {
    ...
    public SMMBikeShareVariables(double travelTime_u_min, double access_Time, double egress_Time, double parkingTime_u_min, int freeFloating, int pedelec, double battery, double availability, double cost) {
