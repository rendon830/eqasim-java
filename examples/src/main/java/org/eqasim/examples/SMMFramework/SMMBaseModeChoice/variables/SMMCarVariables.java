...
/**
 * Class  acts as container for car trip variables for utility
 */

public class SMMCarVariables implements BaseVariables {
    ...
    public SMMCarVariables(double travelTime_u_min, double access_Time, double egress_Time, double parkingTime_u_min, double cost) {
