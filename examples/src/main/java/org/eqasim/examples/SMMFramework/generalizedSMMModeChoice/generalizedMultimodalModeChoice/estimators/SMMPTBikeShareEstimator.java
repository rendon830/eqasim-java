...
/**
 * Class estimates the utility of a PT-bikeshare trip based on the variables of such
 */
public class SMMPTBikeShareEstimator implements UtilityEstimator {
    ...
    public SMMPTBikeShareEstimator(SMMParameters parameters, SMMPTBikeSharePredictor sharingPTPredictor, String mode) {
