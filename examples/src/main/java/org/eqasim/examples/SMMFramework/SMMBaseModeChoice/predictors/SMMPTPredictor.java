...
/**
 *  Class  evaluates the characteristics of a PT trip ; Based in Eqasim base PT predictor
 */
public class SMMPTPredictor extends CachedVariablePredictor<SMMPTVariables> {
    private CostModel costModel;
    @Inject
    public SMMPTPredictor(@Named("pt") CostModel costModel) {
        this.costModel = costModel;
    }


    @Override
    public SMMPTVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
        ...
        return new SMMPTVariables(inVehicleTime_min,accessTime_min,egressTime_min,cost_CHF,0.5,numberOfLineSwitches);
    }
}
