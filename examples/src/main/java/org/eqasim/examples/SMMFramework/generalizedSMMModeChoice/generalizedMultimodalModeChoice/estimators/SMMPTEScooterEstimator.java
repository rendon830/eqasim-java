...
/**
 * Class estimates the utility of a PT-eScooter trip based on the variables of such
 */
public class SMMPTEScooterEstimator implements UtilityEstimator {

    private final SMMParameters parameters;
    private final SMMPTBikeSharePredictor sharingPTPredictor;
    private final String name;



    public SMMPTEScooterEstimator(SMMParameters parameters, SMMPTBikeSharePredictor sharingPTPredictor, String mode) {
    ...
    protected double estimatePersonalUtilityPT(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements){
        ...
        return(ageU+bikeAcc+pTAcc+carAcc+parameters.pt.sigma);
    }
    protected double estimatePersonalUtilitySharing(Person person, DiscreteModeChoiceTrip trip,List<? extends PlanElement> elements){
        ...
        return(ageU+bikeAcc+pTAcc+carAcc+parameters.eScooter.sigma);
    }
