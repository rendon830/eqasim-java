...
/**
 * Class  acts as container for personal variables for utility
 */
public class SMMEqasimPersonVariables extends PersonVariables {
    ...
    Double randomCost;
    public SMMEqasimPersonVariables(int age_a, int bikeAcc, int carAccessibility, int ptPass, int maasPass) {
        super(age_a);
