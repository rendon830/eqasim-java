...
public class PTSharingEstimator implements UtilityEstimator {
    private final SMMParameters parameters;
    private final PTSharingPredictor sharingPTPredictor;
    @Inject
    public PTSharingEstimator(SMMParameters parameters, PTSharingPredictor sharingPTPredictor) {
