...
public class SharingPTEstimator implements UtilityEstimator {

    private final SMMParameters parameters;
    private final SharingPTPredictor sharingPTPredictor;
    @Inject
    public SharingPTEstimator(SMMParameters parameters, SharingPTPredictor sharingPTPredictor) {
